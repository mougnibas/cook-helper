...
public class ITestShopListManagerImplMakeShoplist {
  ...
  public void testMakeShopLists() {
    ...
    Shoplist expected = new Shoplist(new RawMaterial[] {
        new RawMaterial("Oignon", FoodFamily.VEGETABLE, FoodUnit.GRAMME, 210),
        ...
        new RawMaterial("Dès de tomates (en conserve)", FoodFamily.VEGETABLE, FoodUnit.GRAMME, 200),
